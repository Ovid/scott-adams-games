...
ok !strncasecmp( 'HIT', 'KIl', 3 ), '... but not if the words are different';
...
ok !defined MatchUpItem( 'ax', 2 ), 'If an item is not at the specified location, MatchUpItem should return undef';
...
is_similar Look(), $expected_starting_look, '... and our starting Look() should reveal the correct location';
